...
def append_history(cold_water, cold_water_payment,
    ...
    data += f" \'Cold water payment\':{cold_water_payment},"
    data += f" \'Hot water\':{hot_water},"
    data += f" \'Hot water payment\':{hot_water_payment},"
    data += f" \'Electricity\':{electricity},"
    data += f" \'Electricity payment\':{electricity_payment},"
    data += f" \'Total Payment\':{total_payment}"
    data += "}"
